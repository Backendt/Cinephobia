...
class WarnControllerTests {
    ...
    private static List<WarnDTO> testDTOs;
    ...
    static void initTests() {
        ...
        testDTOs = List.of(new WarnDTO(4L, testMedia.getId(), triggerDTO, 5));
    }
    ...
    void getWarnsForMediaTest() throws Exception {
        ...
        Page<WarnDTO> expectedWarns = new PageImpl<>(testDTOs);
        ...
        verify(service).getWarnsForMedia(mediaId, mediaType, Pageable.ofSize(defaultPageIndex));
    }
